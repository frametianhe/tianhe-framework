...
public class DisruptorExecutor {  
    ...
    public static void test() {  
        ...
        WorkerPool<SimpleEvent> workerPool = new WorkerPool<SimpleEvent>(buffer,buffer.newBarrier(), new IgnoreExceptionHandler(),
    ...
    //扩展workerPool，包装服务，网页，架构图，线程池架构图，总结，线程池总结，区别
}  